...
(function () {
    ...
    test("Math", function () {
        ...
        equals(Utils.add(1,2), 3, "add");
        equals(Utils.multiply(2, 2), 4, "multiply");
        equals(Utils.divide(2, 2), 1, "divide");
        equals(Utils.Math.add(1, 2), 3, "add using math namespace");
        equals(Utils.Math.subtract(3, 1), 2, "subtract using math namespace");
    });
    ...
    test("return a config message", function () {
        var result = Application.invalidRequest(Application.config);
